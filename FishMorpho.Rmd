...
# Preliminaries
The simplified version of the dataset of fish outlines is included in the package [Momocs (v > 1.2.2)](http://github.com/vbonhomme/Momocs). The complete dataset can be downloaded [here](https://github.com/rfrelat/FishMorpho/raw/master/nsfishes.Rdata). Make sure the file `CoralFishes.Rdata` is in your working directory, then load it in R.
